...
这是这套东西里**最常见的一种失败**，而且失败理由看起来和正文毫不相干
（系统只会说"某个数字不在引用范围内"）。

反过来说：**每条引用都要真用得上**。报 6 条里只有 1 条和正文有关，
说明你在凑数，那也会让这条结论失去说服力。
...
**宁可多报一条，也不要漏报。** 漏报会让这次回答白写 —— 这是这套东西里
**最常见的一种失败**，而且失败理由看起来和正文毫不相干。
最多 **6 条**，超了整次回答会被丢弃（不会截断）。`
